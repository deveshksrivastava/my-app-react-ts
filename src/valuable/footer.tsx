...
const Footer = () => {
  ...
  return (
    // <div classNameNameName="  bg-[#f5d5d3] w-full text-center pb-3 border-b  border-gray-500 ">
    <section className="py-10 bg-blue-900 sm:pt-16 lg:pt-24 absolute  w-full">
      <div className="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
        ...
        <div className="mt-20 md:mt-28 2xl:mt-32">
          <div className="lg:flex lg:items-center lg:justify-between">
            ...
            <p className="mt-6 text-sm text-blue-200 lg:mt-0">© 5Copyright 2021, All Rights Reserved by
              Postcraft
            </p>
          </div>
        </div>
